...
if __name__ == '__main__':
    ...
    parser.add_argument('--exper_name', type=str, default='superpoint_glue_official',help='path to source image directory')
    parser.add_argument('--img_dir', type=str, default='datasets/Camera/',help='path to source image directory')
    parser.add_argument('--Result_dir', type=str, default='Results/Camera/',help='Directory where to write matching Results ')
    ...
    parser.add_argument('--descriptor_dim',type=int, default=256,help='The dimension of feature descriptor')

    #superglue hyper parameter
    parser.add_argument('--superpoint_weights',type=str,default="supeeglue/models/weights/superpoint_v1.pth",help='SuperPoint official weights') 
    parser.add_argument('--superglue_weights', type=str, default='superglue/models/weights/superglue_indoor.pth',help='SuperGlue official weights')
